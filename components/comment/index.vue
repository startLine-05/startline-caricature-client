			...
			<view class="right">
				<view class="top">
					...
					<view class="like" :class="{ highlight: res.isLike }">
						...
						<u-icon v-if="!res.isLike" name="thumb-up" :size="20" color="#9a9a9a" @click="getLike(index)"></u-icon>
						<u-icon v-if="res.isLike" name="thumb-up-fill" :size="20" @click="getLike(index)"></u-icon>
					</view>
				</view>
